from llm import llm_request_for_json
...
def evaluation_for_memory_integrity(extract_memories: str, target_memory: str):
    """
    ...
    prompt = EVALUATION_PROMPT_FOR_MEMORY_INTEGRITY.format(
        memories=extract_memories, expected_memory_point=target_memory
    )
...
def evaluation_for_memory_accuracy(dialogue: str, golden_memories: str, candidate_memory: str):
    """
    ...
    prompt = EVALUATION_PROMPT_FOR_MEMORY_ACCURACY.format(
        dialogue=dialogue, golden_memories=golden_memories, candidate_memory=candidate_memory
    )
...
def evaluation_for_update_memory(
    extract_memories: str, target_update_memory: str, original_memory: str
):
    """
...
def evaluation_for_question(
    question: str, reference_answer: str, key_memory_points: str, response: str
):
    """
